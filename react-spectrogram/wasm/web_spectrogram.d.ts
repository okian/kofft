...
export interface InitOutput {
  ...
  readonly metadataextractor_extract_metadata: (a: number, b: number, c: number, d: number, e: number) => any;
  ...
  readonly spectrogramprocessor_get_frequency_bins: (a: number, b: number) => [number, number];
  readonly __wbg_seekbarprocessor_free: (a: number, b: number) => void;
  readonly seekbarprocessor_new: (a: number, b: number) => number;
  readonly seekbarprocessor_generate_waveform: (a: number, b: number, c: number) => [number, number];
